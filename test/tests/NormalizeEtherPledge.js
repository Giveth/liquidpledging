...
describe('NormalizeEtherPledge test', function() {
  this.timeout(0);
  ...
  it('Should commit pledges if commitTime has passed', async () => {
    // commitTime 259200
    await liquidPledging.donate(1, 2, { value: 1000, from: giver1 });
    // commitTime 86400
    await liquidPledging.donate(1, 3, { value: 1000, from: giver1 });
    // commitTime 0
    await liquidPledging.donate(6, 3, { value: 1000, from: giver2 });
